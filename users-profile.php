...
<head>
  ...
  <title>Users / Profile - ChiliCare</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-blank.bobot">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">ChiliCare adalah aplikasi inovatif yang dirancang untuk membantu petani dalam menanam cabai dengan lebih efektif dan efisien. Menggunakan teknologi sensor canggih, ChiliCare memantau suhu, kelembaban, dan kesuburan tanah secara real-time, memberikan data yang akurat dan praktis bagi petani.</p>

                  <h5 class="card-title">Profile Details</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                    <div class="col-lg-9 col-md-8">ChiliCare Admin</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Country</div>
                    <div class="col-lg-9 col-md-8">Yogyakarta</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">chilicare@gmail.com</div>
                  </div>
